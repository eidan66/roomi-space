...
import { Download, FileText, Image, Package, Share2 } from 'lucide-react';
    ...
    <Card className="border-0 shadow-sm">
      ...
      <CardContent className="space-y-3">
        <div className="grid grid-cols-2 gap-2">
          <Button variant="outline" size="sm" onClick={exportAsJSON} className="text-xs">
            <Package className="w-3 h-3 mr-1" />
            JSON Data
          </Button>
          <Button variant="outline" size="sm" onClick={exportAsCSV} className="text-xs">
