...
export default function Footer() {
  ...
  // Bulletproof RTL/LTR flex direction
        ...
        <div className={`lg:flex lg:gap-12 ${flexDirectionClass}`}>
          ...
          <div className="lg:w-1/2 space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <h4 className="font-semibold text-foreground">{t('footer.newsletter.title')}</h4>
                <p className="text-xs text-muted-foreground">{t('footer.newsletter.description')}</p>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-3 hover:bg-green-100 dark:hover:bg-green-900/30 transition-all duration-200 hover:scale-105 cursor-pointer">
                  ...
                  >
                    ...
                    <div>
                      <div className="font-medium text-sm">{t('footer.whatsapp.quickHelp')}</div>
                      <div className="text-xs opacity-80">{t('footer.whatsapp.support')}</div>
                    </div>
                  </a>
                </div>
          ...
          <div className="lg:w-1/2 space-y-6">
            <div className="bg-background/50 border border-border rounded-lg p-6 space-y-4 hover:bg-background/80 transition-all duration-200">
              <h3 className="font-semibold text-foreground text-lg">{t('footer.contactForm.title')}</h3>
        ...
        <div className="mt-12 pt-8 border-t border-border">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            ...
            <div className="flex items-center space-x-4 rtl:space-x-reverse">
              <span className="text-sm font-medium text-muted-foreground">{t('footer.social')}:</span>
